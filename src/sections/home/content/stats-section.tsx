...
const stats = [
  {
    ...
    description: "Career paths discovered and professional journeys launched"
  },
  {
    number: "500+",
    label: "Expert Mentors",
    description: "Industry professionals providing personalized guidance"
  },
  {
    number: "95%",
    label: "Success Rate",
    description: "Students find fulfilling careers within 6 months"
  },
  {
    number: "50+",
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-16">
        <div className="text-center mb-16">
          ...
          <p className="font-body text-lg text-muted-foreground max-w-2xl mx-auto">
            Join a growing community of professionals who found their perfect career path with CareerPath
          </p>
        </div>
